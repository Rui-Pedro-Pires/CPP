...
template <typename T, typename ContainerType>
MutantStack<T, ContainerType>::MutantStack( const MutantStack &other ) : std::stack<T, ContainerType>( other )
{
}
...
template <typename T, typename ContainerType>
MutantStack<T, ContainerType>::Iterator::Iterator( MutantStack<T, ContainerType> &mutantStack, unsigned int idx )
...
template <typename T, typename ContainerType>
MutantStack<T, ContainerType>::Iterator::Iterator( const MutantStack<T, ContainerType>::Iterator &other )
...
template <typename T, typename ContainerType>
bool MutantStack<T, ContainerType>::Iterator::operator==( const MutantStack<T, ContainerType>::Iterator &other )
{
